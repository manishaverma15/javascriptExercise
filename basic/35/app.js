...
function eight(){
    ...
    if(x==8 || y==8){
        document.getElementById("paragraph").innerText="From given numbers one number is eight"
    }

    if(z==8||k==8){
        document.getElementById("paragraph").innerText="Either sum or difference is 8"
